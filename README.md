...
##### LAB 3  : **Config Server**
    * Fork this to your Git Account..https://github.com/reagul/config-repo. Note the Github id that you will use in the file below in the line <yourgitHubID>
    * Create this file on your local dir with this content. Name this file config-server.json
    
    	{
    "git" : {
        "uri": "https://github.com/<yourgitHubID>/config-repo"
    		}
	}
